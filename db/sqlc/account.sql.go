...
WHERE id = $2
RETURNING id, owner, balance, currency, craeted_at
`
...
SELECT id, owner, balance, currency, craeted_at FROM accounts WHERE id = $1 LIMIT 1
`
...
SELECT id, owner, balance, currency, craeted_at FROM accounts WHERE id = $1 LIMIT 1 FOR NO KEY UPDATE
`
...
SELECT id, owner, balance, currency, craeted_at FROM accounts 
ORDER BY id
LIMIT $1 OFFSET $2
`
